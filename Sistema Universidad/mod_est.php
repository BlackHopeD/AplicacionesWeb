...
function ConsultarProducto($idalumnos){
    include ("conexion.php");
    $sentencia="SELECT * FROM alumno_table WHERE idalumnos='$idalumnos'";
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="javascript:;">Modificar estudiante</a>
          </div>
            ...
            <div class="col-md-8">
              <div class="card">
                <div class="card-header card-header-danger">
                  ...
                  <p class="card-category">Modifique los datos del estudiante por favor:</p>
                </div>
                <div class="card-body">
                  <form method="POST" action="mod_est2.php">
                    <div class="row">
                      <div class="col-md-5">
                        <div class="form-group">
                          <label class="bmd-label-floating">Nombre completo</label>
                          <input type="hidden" name="idalumnos" id="idalumnos" class="form-control"value="<?php echo $consulta[6] ?>" placeholder="Nombre" >
