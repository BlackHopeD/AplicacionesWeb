      ...
      <div class="sidebar-wrapper">
        <ul class="nav">
          <li class="nav-item active">
            <a class="nav-link " href="./profesor_page.php">
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category">Aqui podra visualizar la lista de Estudiantes</p>
                  ...
                  <div class="table-responsive">
                    <table class="table">
                      ...
                      <tbody>
                                        ...
                                        $consulta = "SELECT nombre FROM materia_table where email_profesor='$_SESSION[email]'"; 
                                        $result = mysqli_query($conn, $consulta);
                                        $fila=$result->fetch_assoc();
                                         $var= $fila['nombre'];
                                         
                                         $consulta2="SELECT materia,aula,codigo,email,hora from materia_alumno_table where materia='$var'";
