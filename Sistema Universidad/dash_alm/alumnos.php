...
<body>
    ...
    <div class="card text-black">
        <img class="card-img" src="https://eitrawmaterials.eu/wp-content/uploads/2019/05/Label-brochure-1.jpg" alt="Card image">
        <div class="card-img-overlay">
            <h3 class="card-title">Bienvenido/a <?php echo $_SESSION['email']; ?> </h3>
            <p class="card-text"></p>
        </div>
    </div>
    </br>
