...
<body>
    ...
    <!-- <div class="container mt-4 shadowbox">
        <div class="card-deck">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Card title</h5>
                    <a class="btn btn-secondary" href="#" role="button" id="agregar" aria-haspopup="true" aria-expanded="false">
                        Agregar Materia
                    </a>
                </div>
            </div>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        while ($fila = $result->fetch_assoc()) {
                                            ...
                                            echo "</td>";
                                            echo "<td>";
                                             echo "<a href='alumno_materia.php?data=".$fila['nombre']."'> <buttontype='button' class='btn btn-warning'>Agregar materia</button>";
