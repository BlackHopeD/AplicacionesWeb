            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category">Aqui podra agregarle a las materias sus profesores.</p>
                </div>
                <div class="card-body">
                      ...
                      <?php 
                         ...
                         $result=mysqli_query($conn,$consulta);
                          while($fila=$result->fetch_assoc()){
                            ...
                            echo "<td>"; echo"<a href='./mod_matprof.php?data=".$fila['idmateria_table']."'> <buttontype='submit' class='btn btn-warning'>Agregar profesor</button>"; echo"</td>";  
                            echo "</tr>";
                           }
                         ?>       
                      </tbody>
